    ...
    <>
      <div className="bg-white rounded-5 py-1 px-5 d-flex flex-column align-items-start">
        ...
        <form onSubmit={handleReplySubmit} className="d-flex w-100 p-0 ">
          <div
            className={`${styles.responder} d-flex flex-column container-fluid align-self-center my-5 py-2 px-3  w-100 rounded-5`}
          >
            <textarea
            ...
            <button
              type="submit"
              className={`${styles.button} align-self-end bg-white text-dark mt-3`}
            >
              Responder
            </button>
          </div>
